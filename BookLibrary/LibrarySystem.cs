...
public class LibrarySystem
{
    ...
    public bool AddBook(Book book)
    {
        ...
        foreach(var num in book.ISBN)
        {
            if(!char.IsDigit(num)) return false;
        }

        if(SearchByISBN(book.ISBN)!=null) return false;
    ...
    {
        return books.FirstOrDefault(b => b.ISBN.Contains(isbn, StringComparison.OrdinalIgnoreCase));
    }
